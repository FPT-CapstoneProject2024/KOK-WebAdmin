...
namespace WebAdmin.Pages.Genre
{
    public class IndexModel : PageModel
    {
        ...
        [BindProperty]
        public DynamicModelResponse.DynamicModelsResponse<DTOModels.Response.Genre> data { get; set; } = new DynamicModelResponse.DynamicModelsResponse<DTOModels.Response.Genre>();
        [BindProperty]
        ...
        public async Task<IActionResult> OnGet(string? number = null, string? filter = null)
        {
            try
            {
                ...
                var uri = KokApiContext.BaseApiUrl + "/" + KokApiContext.GenreResource + "/" + "get-genres";
...
#pragma warning disable CS8601 // Possible null reference assignment.
                data = JsonConvert.DeserializeObject<DynamicModelResponse.DynamicModelsResponse<DTOModels.Response.Genre>>(jsonResponse);
