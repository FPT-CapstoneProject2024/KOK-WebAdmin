...
namespace WebAdmin.Pages.Transactions
{
    public class GameModel : PageModel
    {
        ...
        [BindProperty]
        public DynamicModelResponse.DynamicModelsResponse<DTOModels.Response.InAppTransaction> data { get; set; } = new DynamicModelResponse.DynamicModelsResponse<DTOModels.Response.InAppTransaction>();
        [BindProperty]
