...
namespace WebAdmin.Pages.Artist
{
    public class IndexModel : PageModel
    {
        ...
        [BindProperty]
        public DynamicModelResponse.DynamicModelsResponse<DTOModels.Response.Artist> data { get; set; } = new DynamicModelResponse.DynamicModelsResponse<DTOModels.Response.Artist>();
        [BindProperty]
        ...
        public async Task<IActionResult> OnGet(string? number = null, string? filter = null)
        {
            try
            {
                ...
                var uri = KokApiContext.BaseApiUrl + "/" + KokApiContext.ArtistResource + "/" + "get-artists";
...
#pragma warning disable CS8601 // Possible null reference assignment.
                data = JsonConvert.DeserializeObject<DynamicModelResponse.DynamicModelsResponse<DTOModels.Response.Artist>>(jsonResponse);
