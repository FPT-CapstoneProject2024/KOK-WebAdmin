...
namespace WebAdmin.Pages.Singer
{
    public class IndexModel : PageModel
    {
        ...
        [BindProperty]
        public DynamicModelResponse.DynamicModelsResponse<DTOModels.Response.Singer> data { get; set; } = new DynamicModelResponse.DynamicModelsResponse<DTOModels.Response.Singer>();
        [BindProperty]
...
#pragma warning disable CS8601 // Possible null reference assignment.
                data = JsonConvert.DeserializeObject<DynamicModelResponse.DynamicModelsResponse<DTOModels.Response.Singer>>(jsonResponse);
